...
namespace MantaCil\Services\Allocations;
...
class FindAssignableAllocationService
{
    ...
    {
        if (!config('mantacil.client_features.allocations.enabled')) {
    ...
    {
        $start = config('mantacil.client_features.allocations.range_start', null);
        $end = config('mantacil.client_features.allocations.range_end', null);
