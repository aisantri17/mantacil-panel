...
namespace MantaCil\Services\Databases;
...
use MantaCil\Extensions\DynamicDatabaseConnection;
use MantaCil\Repositories\Eloquent\DatabaseRepository;
use MantaCil\Exceptions\Repository\DuplicateDatabaseNameException;
use MantaCil\Exceptions\Service\Database\TooManyDatabasesException;
use MantaCil\Exceptions\Service\Database\DatabaseClientFeatureNotEnabledException;
...
class DatabaseManagementService
{
     ...
     *
     * @see \MantaCil\Services\Databases\DatabaseManagementService::generateUniqueDatabaseName()
     */
    ...
    {
        if (!config('mantacil.client_features.databases.enabled')) {
        ...
        try {
            ...
            try {
                ...
                // itself isn't able to be created in MantaCil's database.
                //
