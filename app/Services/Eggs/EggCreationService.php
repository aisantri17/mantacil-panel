...
namespace MantaCil\Services\Eggs;

use Ramsey\Uuid\Uuid;
use MantaCil\Models\Egg;
use MantaCil\Contracts\Repository\EggRepositoryInterface;
use Illuminate\Contracts\Config\Repository as ConfigRepository;
use MantaCil\Exceptions\Service\Egg\NoParentConfigurationFoundException;

// When a mommy and a daddy mantacil really like each other...
class EggCreationService
{
    ...
    public function handle(array $data): Egg
    {
        ...
        return $this->repository->create(array_merge($data, [
            ...
            'author' => $this->config->get('mantacil.service.author'),
        ]), true, true);
    }
}
