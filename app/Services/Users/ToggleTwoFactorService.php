...
use MantaCil\Repositories\Eloquent\RecoveryTokenRepository;
use MantaCil\Exceptions\Service\User\TwoFactorAuthenticationTokenInvalid;
...
class ToggleTwoFactorService
{
    ...
    public function handle(User $user, string $token, ?bool $toggleState = null): array
    {
        ...
        $isValidToken = $this->google2FA->verifyKey($secret, $token, config()->get('mantacil.auth.2fa.window'));
