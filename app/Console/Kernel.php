...
namespace MantaCil\Console;

use Ramsey\Uuid\Uuid;
use MantaCil\Models\ActivityLog;
use Illuminate\Console\Scheduling\Schedule;
use Illuminate\Database\Console\PruneCommand;
use MantaCil\Repositories\Eloquent\SettingsRepository;
use Illuminate\Foundation\Console\Kernel as ConsoleKernel;
use MantaCil\Services\Telemetry\TelemetryCollectionService;
use MantaCil\Console\Commands\Schedule\ProcessRunnableCommand;
use MantaCil\Console\Commands\Maintenance\PruneOrphanedBackupsCommand;
use MantaCil\Console\Commands\Maintenance\CleanServiceBackupFilesCommand;
...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        if (config('mantacil.telemetry.enabled')) {
