...
class DatabaseSettingsCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        $this->variables['DB_USERNAME'] = $this->option('username') ?? $this->ask(
            'Database Username',
            config('database.connections.mysql.username', 'mantacil')
        );
        ...
        try {
            ...
            if ($this->confirm('Go back and try again?')) {
                $this->database->disconnect('_mantacil_command_test');
    ...
    {
        config()->set('database.connections._mantacil_command_test', [
            'driver' => 'mysql',
        ...
        $this->database->connection('_mantacil_command_test')->getPdo();
    }
}
