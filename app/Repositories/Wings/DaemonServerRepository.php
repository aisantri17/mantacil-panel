...
/**
 * @method \MantaCil\Repositories\Wings\DaemonServerRepository setNode(\MantaCil\Models\Node $node)
 * @method \MantaCil\Repositories\Wings\DaemonServerRepository setServer(\MantaCil\Models\Server $server)
 */
class DaemonServerRepository extends DaemonRepository
{
     ...
     *
     * @deprecated
     * @see \MantaCil\Repositories\Wings\DaemonRevocationRepository::deauthorize()
     *
     * @throws DaemonConnectionException
     */
