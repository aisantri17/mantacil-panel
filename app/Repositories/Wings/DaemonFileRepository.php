...
use MantaCil\Exceptions\Http\Server\FileSizeTooLargeException;
use MantaCil\Exceptions\Http\Connection\DaemonConnectionException;

/**
 * @method \MantaCil\Repositories\Wings\DaemonFileRepository setNode(\MantaCil\Models\Node $node)
 * @method \MantaCil\Repositories\Wings\DaemonFileRepository setServer(\MantaCil\Models\Server $server)
 */
