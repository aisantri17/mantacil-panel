...
namespace MantaCil\Models;

use Illuminate\Notifications\Notifiable;
use Illuminate\Database\Query\JoinClause;
use Znck\Eloquent\Traits\BelongsToThrough;
use MantaCil\Contracts\Models\Identifiable;
use Illuminate\Database\Eloquent\Relations\HasOne;
use Illuminate\Database\Eloquent\Relations\HasMany;
use MantaCil\Models\Traits\HasRealtimeIdentifier;
use Illuminate\Database\Eloquent\Relations\BelongsTo;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Illuminate\Database\Eloquent\Relations\MorphToMany;
use Illuminate\Database\Eloquent\Relations\HasManyThrough;
use MantaCil\Exceptions\Http\Server\ServerStateConflictException;

/**
 * \MantaCil\Models\Server.
 *
 * @property int $id
 ...
 * @property \Illuminate\Database\Eloquent\Collection|\MantaCil\Models\ActivityLog[] $activity
 * @property int|null $activity_count
 * @property Allocation|null $allocation
 * @property \Illuminate\Database\Eloquent\Collection|\MantaCil\Models\Allocation[] $allocations
 * @property int|null $allocations_count
 * @property \Illuminate\Database\Eloquent\Collection|\MantaCil\Models\Backup[] $backups
 * @property int|null $backups_count
 * @property \Illuminate\Database\Eloquent\Collection|\MantaCil\Models\Database[] $databases
 * @property int|null $databases_count
 * @property Egg|null $egg
 * @property \Illuminate\Database\Eloquent\Collection|\MantaCil\Models\Mount[] $mounts
 * @property int|null $mounts_count
 * @property Nest $nest
 * @property Node $node
 * @property \Illuminate\Notifications\DatabaseNotificationCollection|\Illuminate\Notifications\DatabaseNotification[] $notifications
 * @property int|null $notifications_count
 * @property \Illuminate\Database\Eloquent\Collection|\MantaCil\Models\Schedule[] $schedules
 * @property int|null $schedules_count
 * @property \Illuminate\Database\Eloquent\Collection|\MantaCil\Models\Subuser[] $subusers
 * @property int|null $subusers_count
 * @property ServerTransfer|null $transfer
 * @property User $user
 * @property \Illuminate\Database\Eloquent\Collection|\MantaCil\Models\EggVariable[] $variables
...
class Server extends Model implements Identifiable
{
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo<\MantaCil\Models\User, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\MantaCil\Models\Subuser, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne<\MantaCil\Models\Allocation, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\MantaCil\Models\Allocation, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo<\MantaCil\Models\Nest, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne<\MantaCil\Models\Egg, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\MantaCil\Models\EggVariable, $this>
     */
    public function variables(): HasMany
    {
        return $this->hasMany(EggVariable::class, 'egg_id', 'egg_id')
            ...
            ->leftJoin('server_variables', function (JoinClause $join) {
                ...
                //
                // @see https://github.com/mantacil/panel/issues/2250
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo<\MantaCil\Models\Node, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\MantaCil\Models\Schedule, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\MantaCil\Models\Database, $this>
     */
     ...
     *
     * @return \Znck\Eloquent\Relations\BelongsToThrough<\MantaCil\Models\Location, \MantaCil\Models\Node>
     *
     * @throws \Exception
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasOne<\MantaCil\Models\ServerTransfer, $this>
     */
    ...
    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\MantaCil\Models\Backup, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasManyThrough<\MantaCil\Models\Mount, \MantaCil\Models\MountServer, $this>
     */
     ...
     *
     * @return \Illuminate\Database\Eloquent\Relations\MorphToMany<\MantaCil\Models\ActivityLog, $this>
     */
