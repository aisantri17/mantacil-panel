...
use MantaCil\Exceptions\Http\HttpForbiddenException;
use MantaCil\Transformers\Api\Client\TaskTransformer;
use MantaCil\Http\Requests\Api\Client\ClientApiRequest;
use MantaCil\Http\Controllers\Api\Client\ClientApiController;
use MantaCil\Exceptions\Service\ServiceLimitExceededException;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use MantaCil\Http\Requests\Api\Client\Servers\Schedules\StoreTaskRequest;
...
class ScheduleTaskController extends ClientApiController
{
    ...
    {
        $limit = config('mantacil.client_features.schedules.per_schedule_task_limit', 10);
