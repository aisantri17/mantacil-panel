...
use MantaCil\Helpers\Utilities;
use MantaCil\Exceptions\DisplayException;
use MantaCil\Repositories\Eloquent\ScheduleRepository;
use MantaCil\Services\Schedules\ProcessScheduleService;
use MantaCil\Transformers\Api\Client\ScheduleTransformer;
use MantaCil\Http\Controllers\Api\Client\ClientApiController;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use MantaCil\Http\Requests\Api\Client\Servers\Schedules\ViewScheduleRequest;
use MantaCil\Http\Requests\Api\Client\Servers\Schedules\StoreScheduleRequest;
use MantaCil\Http\Requests\Api\Client\Servers\Schedules\DeleteScheduleRequest;
use MantaCil\Http\Requests\Api\Client\Servers\Schedules\UpdateScheduleRequest;
use MantaCil\Http\Requests\Api\Client\Servers\Schedules\TriggerScheduleRequest;
...
class ScheduleController extends ClientApiController
{
    ...
    public function update(UpdateScheduleRequest $request, Server $server, Schedule $schedule): array
    {
        ...
        //
        // @see https://github.com/mantacil/panel/issues/2425
