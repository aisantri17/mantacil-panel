...
use MantaCil\Services\Subusers\SubuserCreationService;
use MantaCil\Transformers\Api\Client\SubuserTransformer;
use MantaCil\Repositories\Wings\DaemonRevocationRepository;
use MantaCil\Http\Controllers\Api\Client\ClientApiController;
use MantaCil\Http\Requests\Api\Client\Servers\Subusers\GetSubuserRequest;
use MantaCil\Http\Requests\Api\Client\Servers\Subusers\StoreSubuserRequest;
use MantaCil\Http\Requests\Api\Client\Servers\Subusers\DeleteSubuserRequest;
use MantaCil\Http\Requests\Api\Client\Servers\Subusers\UpdateSubuserRequest;
...
class SubuserController extends ClientApiController
{
     ...
     * @throws \MantaCil\Exceptions\Service\Subuser\ServerSubuserExistsException
     * @throws \MantaCil\Exceptions\Service\Subuser\UserIsServerOwnerException
     * @throws \Throwable
     */
    ...
    {
        /** @var \MantaCil\Models\Subuser $subuser */
        $subuser = $request->attributes->get('subuser');
