...
use MantaCil\Services\Eggs\EggConfigurationService;
use MantaCil\Exceptions\Http\HttpForbiddenException;
use MantaCil\Repositories\Eloquent\ServerRepository;
use MantaCil\Http\Resources\Wings\ServerConfigurationCollection;
    ...
    public function resetState(Request $request): JsonResponse
    {
        ...
        $this->connection->transaction(function () use ($node, $servers) {
            ...
            foreach ($servers as $server) {
                /** @var \MantaCil\Models\ActivityLog|null $activity */
