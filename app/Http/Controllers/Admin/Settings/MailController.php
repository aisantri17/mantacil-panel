...
namespace MantaCil\Http\Controllers\Admin\Settings;

use Illuminate\View\View;
use Illuminate\Http\Request;
use Illuminate\Http\Response;
use Illuminate\Contracts\Console\Kernel;
use MantaCil\Notifications\MailTested;
use Illuminate\Support\Facades\Notification;
use MantaCil\Exceptions\DisplayException;
use MantaCil\Http\Controllers\Controller;
use Illuminate\Contracts\Encryption\Encrypter;
use MantaCil\Providers\SettingsServiceProvider;
use Illuminate\Contracts\Config\Repository as ConfigRepository;
use MantaCil\Contracts\Repository\SettingsRepositoryInterface;
use MantaCil\Http\Requests\Admin\Settings\MailSettingsFormRequest;
