...
namespace MantaCil\Extensions\Spatie\Fractalistic;
...
use MantaCil\Extensions\League\Fractal\Serializers\MantaCilSerializer;
...
class Fractal extends SpatieFractal
{
    ...
    public function createData(): Scope
    {
        ...
        if (is_null($this->serializer)) {
            $this->serializer = new MantaCilSerializer();
        }
