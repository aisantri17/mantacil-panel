...
class SettingsServiceProvider extends ServiceProvider
{
    ...
    protected array $keys = [
        ...
        'mantacil:guzzle:timeout',
        'mantacil:guzzle:connect_timeout',
        'mantacil:console:count',
        'mantacil:console:frequency',
        'mantacil:auth:2fa_required',
        'mantacil:client_features:allocations:enabled',
