...
namespace MantaCil\Tests\Integration\Http\Controllers\Auth;
...
use MantaCil\Events\Auth\DirectLogin;
use PHPUnit\Framework\Attributes\TestWith;
use MantaCil\Tests\Integration\Http\HttpTestCase;
...
class LoginCheckpointControllerTest extends HttpTestCase
{
     ...
     * column value.
     *
     * @see https://github.com/mantacil/panel/security/advisories/GHSA-rgmp-4873-r683
     */
    #[TestWith([1])]
    #[TestWith([30])]
    #[TestWith([80])]
