...
namespace MantaCil\Tests\Integration\Services\Databases;
...
use MantaCil\Exceptions\Service\Database\NoSuitableDatabaseHostException;
...
class DeployServerDatabaseServiceTest extends IntegrationTestCase
{
    ...
    {
        config()->set('mantacil.client_features.databases.allow_random', true);
    ...
    public function testErrorIsThrownIfNoDatabaseHostsExistOnNode()
    {
        ...
        config()->set('mantacil.client_features.databases.allow_random', false);
