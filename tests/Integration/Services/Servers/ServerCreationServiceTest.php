...
namespace MantaCil\Tests\Integration\Services\Servers;
...
use MantaCil\Models\Objects\DeploymentObject;
...
class ServerCreationServiceTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->bungeecord = Egg::query()
            ->where('author', 'support@mantacil.io')
    ...
    public function testServerIsCreatedWithDeploymentObject()
    {
        ...
        /** @var \MantaCil\Models\Allocation[]|\Illuminate\Database\Eloquent\Collection $allocations */
