...
namespace MantaCil\Tests\Integration\Services\Deployment;
...
use MantaCil\Services\Deployment\FindViableNodesService;
use MantaCil\Exceptions\Service\Deployment\NoViableNodeException;
...
class FindViableNodesServiceTest extends IntegrationTestCase
{
     ...
     *
     * @see https://github.com/mantacil/panel/issues/2529
     */
    ...
    {
        /** @var \MantaCil\Models\Location[] $locations */
        $locations = Location::factory()->times(2)->create();

        /** @var \MantaCil\Models\Node[] $nodes */
        $nodes = [
