...
namespace MantaCil\Tests\Integration\Services\Allocations;

use MantaCil\Models\Allocation;
use MantaCil\Tests\Integration\IntegrationTestCase;
use MantaCil\Services\Allocations\FindAssignableAllocationService;
use MantaCil\Exceptions\Service\Allocation\AutoAllocationNotEnabledException;
use MantaCil\Exceptions\Service\Allocation\NoAutoAllocationSpaceAvailableException;
...
class FindAssignableAllocationServiceTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        config()->set('mantacil.client_features.allocations.enabled', true);
        config()->set('mantacil.client_features.allocations.range_start', 0);
        config()->set('mantacil.client_features.allocations.range_end', 0);
    }
    ...
    {
        $server = $this->createServerModel();
        config()->set('mantacil.client_features.allocations.range_start', 5000);
        config()->set('mantacil.client_features.allocations.range_end', 5005);
    ...
    public function testOnlyPortNotInUseIsCreated()
    {
        ...
        config()->set('mantacil.client_features.allocations.range_start', 5000);
        config()->set('mantacil.client_features.allocations.range_end', 5001);
    ...
    {
        $server = $this->createServerModel();
        config()->set('mantacil.client_features.allocations.range_start', 'hodor');
        config()->set('mantacil.client_features.allocations.range_end', 10);
        ...
        config()->set('mantacil.client_features.allocations.range_start', 10);
        config()->set('mantacil.client_features.allocations.range_end', 'hodor');
    ...
    {
        config()->set('mantacil.client_features.allocations.enabled', false);
        $server = $this->createServerModel();
