...
namespace MantaCil\Tests\Integration\Api\Application;
...
use MantaCil\Tests\Traits\Http\IntegrationJsonRequestAssertions;
...
abstract class ApplicationApiIntegrationTestCase extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this
            ->withHeader('Accept', 'application/vnd.mantacil.v1+json')
