...
namespace MantaCil\Tests\Integration\Api\Client\Server\Allocation;

use Illuminate\Http\Response;
use MantaCil\Models\Allocation;
use MantaCil\Models\Permission;
use MantaCil\Tests\Integration\Api\Client\ClientApiIntegrationTestCase;
...
class CreateNewAllocationTest extends ClientApiIntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        config()->set('mantacil.client_features.allocations.range_end', 5050);
    }
    ...
    {
        /** @var \MantaCil\Models\Server $server */
