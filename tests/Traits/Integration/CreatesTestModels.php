...
namespace MantaCil\Tests\Traits\Integration;
...
trait CreatesTestModels
{
     ...
     *
     * @return array{\MantaCil\Models\User, \MantaCil\Models\Server}
     */
    ...
    {
        /** @var Egg $egg */
        $egg = Egg::query()->where('author', 'support@mantacil.io')->where('name', 'Bungeecord')->firstOrFail();
